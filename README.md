...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-2266%20passing-brightgreen" alt="2266 tests passing" />
...
```bash
bun install
bun test             # 2266 tests: schema, signals, runtime, SSR, resume, morph, interop, router, cache, guards, agent loop, harness, SWC stubs
