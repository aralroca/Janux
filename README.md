...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-3505%20passing-brightgreen" alt="3505 tests passing" />
...
```bash
bun install
bun test             # 3505 tests: schema, signals, runtime, SSR, resume, morph, interop, router, cache, guards, agent loop, harness, SWC stubs
