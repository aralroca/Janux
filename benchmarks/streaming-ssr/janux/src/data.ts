...
// This file is byte-identical across the targets (janux / react / preact /
// solid) so every framework streams the same DOM shape on the same clock —
// only the framework glue in App / entry-server.ts differs.
